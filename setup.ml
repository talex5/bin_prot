(* OASIS_START *)
(* DO NOT EDIT (digest: 28024a1ae56b1ff5e6af34885adf836f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bin_shape"; "Core_fragment"; "Std"];
                      lib_pack = true;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["blit_stubs_xen.c"; "config.h"; "float_stubs_xen.c"];
                      bs_data_files = [];
                      bs_ccopt =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\183\159I+\217L\168\1319\221P\146\242@\195\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
